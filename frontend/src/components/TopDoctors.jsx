    ...
    <div className='flex flex-col items-center gap-6 my-16 text-gray-800 md:mx-10 '>
      ...
      <div className='w-full grid grid-cols-[var(--grid-cols-auto)] gap-4 pt-2 gap-y-6 px-3 sm:px-0'>
        {doctors.slice(0, 10).map((item,index) => (
            ...
            <div key={item._id || index} onClick={() => navigate(`/appointment/${item._id}`)} className='  border border-gray-300 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500'>
